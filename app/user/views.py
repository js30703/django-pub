...
from app.authentication.serializers import UserRegisterSerializer, UserSocialLoginSerializer, UserLoginSerializer, \
    UserLogoutSerializer, UserMeSerializer, UserDeviceUpdateSerializer, UserPasswordResetCreateSerializer, \
...
class UserDeviceUpdateView(UpdateAPIView):
    """
    유저 디바이스 수정
    ---
    모바일앱에서만 사용합니다.
    """
    serializer_class = UserDeviceUpdateSerializer
    permission_classes = [IsAuthenticated]
